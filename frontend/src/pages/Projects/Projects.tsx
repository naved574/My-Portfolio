...
export default function Projects() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="text-center text-4xl font-bold">All Projects</h1>
      <p className="mx-auto mt-3 max-w-2xl text-center text-[color:var(--color-muted)]">
        Browse featured work and open each project for complete details.
      </p>
              ...
              {Array.from({ length: pagination.totalPages }, (_, i) => i + 1).map((n) => (
                <button
                  ...
                  className={`h-10 w-10 rounded-full border ${
                    n === page ? "bg-black text-white dark:bg-white dark:text-black" : ""
                  }`}
                >
                  {n}
                </button>
